...
DIST_COMMON = $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(srcdir)/ode.pc.in $(top_srcdir)/configure compile \
...
ACLOCAL = ${SHELL} /home/intelligentrobotics/ode-0.12/missing --run aclocal-1.11
ALLOCA = 
AMTAR = $${TAR-tar}
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/intelligentrobotics/ode-0.12/missing --run autoconf
AUTOHEADER = ${SHELL} /home/intelligentrobotics/ode-0.12/missing --run autoheader
AUTOMAKE = ${SHELL} /home/intelligentrobotics/ode-0.12/missing --run automake-1.11
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/intelligentrobotics/ode-0.12/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
ODE_RELEASE = 0.12
ODE_VERSION_INFO = -version-info 3:0:0
OTOOL = 
OTOOL64 = 
PACKAGE = ode
PACKAGE_BUGREPORT = ode@ode.org
PACKAGE_NAME = ODE
PACKAGE_STRING = ODE 0.12
PACKAGE_TARNAME = ode
PACKAGE_URL = 
...
PKG_CONFIG_LIBDIR = 
PKG_CONFIG_PATH = /home/intelligentrobotics/ws/orocos/orocos_toolchain/install/lib/pkgconfig:/opt/ros/groovy/lib/pkgconfig:/usr/local/lib/pkgconfig
RANLIB = ranlib
SED = /bin/sed
SET_MAKE = 
SHELL = /bin/bash
...
X11_CFLAGS =  
X11_LIBS = -lX11  
abs_builddir = /home/intelligentrobotics/ode-0.12
abs_srcdir = /home/intelligentrobotics/ode-0.12
abs_top_builddir = /home/intelligentrobotics/ode-0.12
abs_top_srcdir = /home/intelligentrobotics/ode-0.12
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/intelligentrobotics/ode-0.12/install-sh
